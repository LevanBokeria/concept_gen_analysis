function preprocess_wave()

%% Description

% This script will preprocess the newest wave data from JATOS with the 
% following steps:
...
rawtext = fileread(fullfile(home,'data',['jatos_results_' batch_wave_name '.txt']));
...
for iPtp = 1:nPtp
    ...
    if ds_exists
        ...
        [split2,~] = split(curr_cell{2},['---' splitter_end]);
