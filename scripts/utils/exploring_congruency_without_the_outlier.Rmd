...
summary_table_ses_1_2_avg_wide_phase <-
        summary_table_ses_1_2_avg %>%
...
summary_table_ses_1_2_avg_long_phase <-
        summary_table_ses_1_2_avg_wide_phase %>%
        pivot_longer()
