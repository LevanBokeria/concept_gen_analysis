...
# Compare the full model, with one lacking the 3-way interaction
full_vs_no_3_way <- bayes_aov[120]/bayes_aov[127] # seems to be inconclusive
full_vs_no_3_way

# Compare full VS lacking congruency:arrangement
full_vs_no_congruency_by_arr <- bayes_aov[122]/bayes_aov[127] # seems to be inconclusive
full_vs_no_congruency_by_arr

# Compare full VS lacking congruency:concept
full_vs_no_congruency_by_concept <- bayes_aov[123]/bayes_aov[127] # seems to be inconclusive
full_vs_no_congruency_by_concept

# Compare full VS lacking arrangement:concept
full_vs_no_arr_by_concept <- bayes_aov[121]/bayes_aov[127] # seems to be inconclusive
full_vs_no_arr_by_concept

# Compare full vs lacking main effect congruency
full_vs_no_congruency  <- bayes_aov[121]/bayes_aov[127] # seems to be inconclusive
full_vs_no_arr_by_concept
